module.exports = function(app, fs, mysql, connection, moment)
{
    ...
    app.get('/Gas/:gasNumber', function(req, res){
      connection.query('SELECT * from iiot WHERE id = ? AND name = "보정적산량" ORDER BY createdAt DESC LIMIT 121',gasID[req.params.gasNumber-1], function(err,result,rows){
          if (err){
